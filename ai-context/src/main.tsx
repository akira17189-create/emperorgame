...
import { initState, getState } from './engine/state';
import { buildInitialGameState } from './data/seed-scenario';
...
// hash 路由
type Route = '/settings' | '/new' | '/court' | '/chronicle' | '/saves' | '/ending' | '/';

function getRoute(): Route {
  const hash = location.hash.replace('#', '') || '/';
  const valid: Route[] = ['/settings', '/new', '/court', '/chronicle', '/saves', '/ending'];
